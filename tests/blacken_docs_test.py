...
def test_format_src_markdown_pycon_with_continuation():
    before = (
        '```pycon\n'
        '    >>> d = {\n'
        '    ...   "a": 1,\n'
...
def test_format_src_markdown_pycon_adds_continuation():
    before = (
        '```pycon\n'
        '    >>> d = {"a": 1,"b": 2,"c": 3,}\n'
        '```\n'
...
def test_format_src_markdown_pycon_preserves_trailing_whitespace():
    before = (
        'hello\n'
        '\n'
        '```pycon\n'
...
def test_format_src_markdown_pycon_indented():
    before = (
        '-hello\n'
        '\n'
        '    ```pycon\n'
...
def test_format_src_markdown_pycon_code_block_is_final_line1():
    before = (
        '```pycon\n'
        '>>> if True:\n'
        '...   pass\n'
...
def test_format_src_markdown_pycon_code_block_is_final_line2():
    before = (
        '```pycon\n'
        '>>> if True:\n'
        '...   pass\n'
...
def test_format_src_markdown_pycon_nested_def1():
    before = (
        '```pycon\n'
        '>>> if True:\n'
        '...     def f(): pass\n'
...
def test_format_src_markdown_pycon_nested_def2():
    before = (
        '```pycon\n'
        '>>> if True:\n'
        '...     def f(): pass\n'
...
def test_format_src_markdown_pycon_empty_line():
    before = (
        '```pycon\n'
        '>>> l = [\n'
        '...\n'
...
def test_format_src_markdown_pycon_preserves_output_indentation():
    before = (
        '```pycon\n'
        '>>> 1 / 0\n'
        'Traceback (most recent call last):\n'
...
def test_format_src_markdown_pycon_elided_traceback():
    before = (
        '```pycon\n'
        '>>> 1 / 0\n'
        'Traceback (most recent call last):\n'
...
def test_format_src_markdown_pycon_no_prompt():
    before = (
        '```pycon\n'
        'pass\n'
        '```\n'
...
def test_format_src_markdown_pycon_comment_before_promopt():
    before = (
        '```pycon\n'
        '# Comment about next line\n'
        '>>> pass\n'
